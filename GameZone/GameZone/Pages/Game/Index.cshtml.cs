...
namespace GameZone.Pages.Game
{
    public class IndexModel : PageModel
    {
        ...
        // Вместо обикновен List, използваме нашия PaginatedList
        public PaginatedList<Models.Game> Game { get; set; } = default!;

        // Променливи за сортирането
